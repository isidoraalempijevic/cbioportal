...
ggsave("grafici/melanoma/mutation_percentage_agg_melanoma.png", plot = p, width = 12, height = 14, dpi = 300)
...
write_xlsx(group_fisher,
           path = "tabele/melanoma/statistika/group_fisher_melanoma.xlsx")
...
ggplot(df_aggressive_plot, aes(x = Category, y = Percentage, fill = Category)) +
  ...
  scale_fill_manual(
    values = c("Mutation" = "#4D4D4D", "No mutation" = "#56B4E9"),
    name = "Mutation Status"  
  ) +
  ylim(0, 100) +
  labs(
    title = "Mutation Percentage in Aggressive Melanoma Samples",
    x = NULL, y = "Percentage (%)"
  ) +
  facet_wrap(~ hugoGeneSymbol, ncol = 3, scales = "free_x") +
  theme_minimal(base_size = 14) +
  theme(
...
ggsave("grafici/melanoma/mutation_percentage_only_aggressive_melanoma.png", plot = p, width = 12, height = 14, dpi = 300)
...
write_xlsx(fisher_aggressive,
           path = "tabele/melanoma/statistika/fisher_aggressive_melanoma.xlsx")
...
# Save the plot
ggsave("grafici/melanoma/mutation_percentage_fams_melanoma.png", plot = p, width = 14, height = 16, dpi = 300)
...
write_xlsx(global_fisher,
           path = "tabele/melanoma/statistika/famA_fisher_melanoma.xlsx")
...
write_xlsx(global_fisher,
           path = "tabele/melanoma/statistika/famB_fisher_melanoma.xlsx")
...
write_xlsx(global_fisher,
           path = "tabele/melanoma/statistika/famD_fisher_melanoma.xlsx")
...
ggsave("grafici/melanoma/mutation_percentage_agg_fams_melanoma.png", plot = p, width = 16, height = 18, dpi = 300)
...
write_xlsx(group_fisher,
           path = "tabele/melanoma/statistika/famA_group_fisher_melanoma.xlsx")
...
write_xlsx(group_fisher,
           path = "tabele/melanoma/statistika/famB_group_fisher_melanoma.xlsx")
...
write_xlsx(group_fisher,
           path = "tabele/melanoma/statistika/famD_group_fisher_melanoma.xlsx")
...
p <- ggplot(df_aggressive_plot, aes(x = Category, y = Percentage, fill = Category)) +
  ...
  scale_fill_manual(values = c("Mutation" = "#4D4D4D", "No mutation" = "#56B4E9")) +
  ylim(0, 100) +
  labs(title = "Mutation percentage in only aggressive melanoma samples",
       x = "", y = "Percentage (%)") +
  facet_wrap(~ hugoGeneSymbol) +
  theme_minimal(base_size = 14) +
  theme(
...
# Save the plot
ggsave("grafici/melanoma/mutation_percentage_aggressive_fams_melanoma.png", plot = p, width = 14, height = 16, dpi = 300)
...
write_xlsx(fisher_aggressive,
           path = "tabele/melanoma/statistika/fisher_aggressive_famA_melanoma.xlsx")
...
write_xlsx(fisher_aggressive,
           path = "tabele/melanoma/statistika/fisher_aggressive_famB_melanoma.xlsx")
...
write_xlsx(fisher_aggressive,
           path = "tabele/melanoma/statistika/fisher_aggressive_famD_melanoma.xlsx")
